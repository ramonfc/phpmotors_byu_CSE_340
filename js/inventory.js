...
function buildInventoryList(data) { 
    ...
    data.forEach(function (element) { 
     ...
     dataTable += `<td><a href='/phpmotors/vehicles?action=mod&invId=${element.invId}' title='Click to modify' class='mini_btn modify'>Modify</a></td>`; 
     dataTable += `<td><a href='/phpmotors/vehicles?action=del&invId=${element.invId}' title='Click to delete' class='mini_btn delete'>Delete</a></td></tr>`; 
    }) 
    dataTable += '</tbody>'; 
