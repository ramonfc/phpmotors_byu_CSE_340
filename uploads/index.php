...
$navList = buildNavigationBar($classifications); // este buildNavigation
...
switch ($action) {
    case 'upload':
        ...
        if ($imageCheck) {
            ...
            // Insert the image notificationrmation to the database, get the result
    ...
    default:
        // Call function to return image notification from database
        $imageArray = getImages();

        // Build the image notificationrmation into HTML for display
        if (count($imageArray)) {
        ...
        // Get vehicles notificationrmation from database
        $vehicles = getVehicles();
        // Build a select list of vehicle notificationrmation for the view
